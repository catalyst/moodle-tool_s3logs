[![ci](https://github.com/catalyst/moodle-tool_s3logs/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/catalyst/moodle-tool_s3logs/actions/workflows/ci.yml?branch=master)
